...
export function StatementUpload() {
    ...
    return (
        <div>
            ...
            <label htmlFor='statement-file-upload' id='custom-file-upload' onDrop={handleDrop}>
                <svg id='doc-upload-svg' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M440-200h80v-167l64 64 56-57-160-160-160 160 57 56 63-63v167ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z" /></svg>
                <input type='file' id='statement-file-upload' />
                <div id='statement-upload-instructions'>Click to upload your bank statements in .PDF, .PNG/.JPG, .csv or .xlsx</div>
                <div id='statement-upload-instructions-2'>Or drag and drop</div>

                {uploadedFile && uploadedFile.map((f, index) => {
                    const ext = getExtension(f.name);
                    const icon = svgFpathMapper[ext]

                    return (
                        <div className="file-uploaded-status" key={index} style={{ marginTop: "20px" }}>
                            {icon}
                            <span>{f.name}</span>
                        </div>
                    )
